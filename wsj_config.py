...
class WSJConfig:
    ...
    SIMPLE_SEARCHES: list[dict] = [
        ...
        {
            'name': 'Bessatsu CoroCoro Comic 1996-1997',
            'mercari_keyword': '別冊コロコロコミック',
            'mercari_url': 'https://jp.mercari.com/search?keyword=%E5%88%A5%E5%86%8A%E3%82%B3%E3%83%AD%E3%82%B3%E3%83%AD%E3%82%B3%E3%83%9F%E3%83%83%E3%82%AF&sort=created_time&order=desc',
            'yahoo_keyword': '別冊コロコロコミック',
            'state_category': 'simple_bessatsu_corocoro_1996_1997',
            'validators': [['別冊'], ['コロコロ'], ['1996', '1997'], ['月刊', '特刊', '増刊', '号', '月号', 'comic', 'コミック']],
        },
        {
        ...
        },
        {
            ...
            'mercari_keyword': '穴久保 ポケットモンスター',
            'yahoo_keyword': '穴久保 ポケットモンスター',
            'state_category': 'simple_anakubo',
            'validators': [
                ['穴久保'],
            ],
            'exclude': ['XY', 'DVD'],
