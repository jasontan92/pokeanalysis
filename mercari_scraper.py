            ...
            with sync_playwright() as p:
                ...
                for page_num in range(1, max_pages + 1):
                    ...
                    try:
                        ...
                        # Check if we got blocked (Cloudflare challenge)
                        title = page.title().lower()
                        if 'blocked' in page.url.lower() or 'just a moment' in title or 'captcha' in page.content().lower():
                            print("Mercari blocked request (Cloudflare challenge)")
                            break
